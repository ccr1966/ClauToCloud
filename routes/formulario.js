...
router.post('/enviar',  function(req, res, next) {
    ...
    transporter.sendMail(mailOptions, function (err, info) {
        ...
        else
        {
          ...
          res.render('MensajesAlUsuario',{mensaje:'Email recieved succesfully. I will contact you soon. Thank you!',pagina:'/index/', usuario:req.session.usuario,id_usuario:req.session.id_usuario});
        }
        }); // transporter ----------------
